...
static std::map<std::string, std::shared_ptr<nlohmann::json>> registered_networks = {
    ...
    { "elements-electrum-regtest",
        std::make_shared<nlohmann::json>(nlohmann::json({ { "name", "Electrum Elements Regtest" },
            { "network", "elements-electrum-regtest" },
            { "address_explorer_url", std::string() }, { "tx_explorer_url", std::string() },
            { "url", "localhost:60401" }, { "tls", false },
            { "default_peers", nlohmann::json::array() },
            { "p2pkh_version", 57u }, { "p2sh_version", 39u }, { "bech32_prefix", "el" }, { "mainnet", false },
