...
static std::map<std::string, std::shared_ptr<nlohmann::json>> registered_networks = {
    { "localtest",
        std::make_shared<nlohmann::json>(nlohmann::json({
            ...
            { "pin_server_url", "https://jadepin-staging.blockstream.com" },
            { "pin_server_onion_url", "" },
            { "pin_server_public_key", "03b32a93bd083d9f8a3c0a0c62d94a93a797acd1005bd73b05f24330280fb35429" },
    ...
    { "liquid",
        std::make_shared<nlohmann::json>(nlohmann::json({
            ...
            { "price_url", "https://green-liquid-mainnet.blockstream.com/prices" },
            { "price_onion_url", "http://liquidbtcgecscpokecnr5uwg2de55shdq7dnvlpzeju7tnefbekicqd.onion/prices" },
            { "liquid", true },
            { "mainnet", true },
            { "max_reorg_blocks", 2 },
            { "min_fee_rate", nullptr },
    ...
    { "testnet-liquid",
        std::make_shared<nlohmann::json>(nlohmann::json({
            ...
            { "pin_server_onion_url", "" },
            { "pin_server_public_key", "03b32a93bd083d9f8a3c0a0c62d94a93a797acd1005bd73b05f24330280fb35429" },
            { "price_url", "https://green-liquid-testnet.blockstream.com/prices" },
            { "price_onion_url", "http://liqtestulh46kwla3mgenugrcogvjjvzr2qdto663hujwnbaewzpkoad.onion/prices" },
            { "liquid", true },
            { "mainnet", false },
            { "max_reorg_blocks", 2 },
            { "min_fee_rate", nullptr },
