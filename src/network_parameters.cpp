...
static std::map<std::string, std::shared_ptr<nlohmann::json>> registered_networks = {
    ...
    { "liquid",
        std::make_shared<nlohmann::json>(nlohmann::json({
            ...
            { "development", false },
            { "electrum_tls", true },
            { "electrum_url", "elements-mainnet.esplora.blockstream.com:50002" },
    ...
    { "testnet-liquid",
        std::make_shared<nlohmann::json>(nlohmann::json({
            ...
            { "development", false },
            { "electrum_tls", true },
            { "electrum_url", "elements-testnet.esplora.blockstream.com:50002" },
    ...
    { "mainnet",
        std::make_shared<nlohmann::json>(nlohmann::json({
            ...
            { "development", false },
            { "electrum_tls", true },
            { "electrum_url", "bitcoin-mainnet.esplora.blockstream.com:50002" },
    ...
    { "testnet",
        std::make_shared<nlohmann::json>(nlohmann::json({
            ...
            { "development", false },
            { "electrum_tls", true },
            { "electrum_url", "bitcoin-testnet.esplora.blockstream.com:50002" },
