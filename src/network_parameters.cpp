...
static std::map<std::string, std::shared_ptr<nlohmann::json>> registered_networks = {
    ...
    { "liquid-electrum-mainnet",
        std::make_shared<nlohmann::json>(nlohmann::json({ { "name", "Electrum Liquid" },
            ...
            { "liquid", true }, { "development", false },
            { "policy_asset", "6f0279e9ed041c3d710a9f57d0c02928416460c4b722ae3457a11eec381c526d" },
            { "blinded_prefix", 12u }, { "ct_exponent", 0 }, { "ct_bits", 52 }, { "bip21_prefix", "liquidnetwork" },
            { "csv_buckets", std::vector<uint32_t>{ 25920, 51840, 65535 } }, { "server_type", "electrum" } })) },

    { "elements-electrum-regtest",
        std::make_shared<nlohmann::json>(nlohmann::json({ { "name", "Electrum Elements Regtest" },
            { "network", "elements-electrum-regtest" }, { "address_explorer_url", std::string() },
            { "tx_explorer_url", std::string() }, { "url", "localhost:60401" }, { "tls", false },
            { "default_peers", nlohmann::json::array() }, { "p2pkh_version", 57u }, { "p2sh_version", 39u },
            { "bech32_prefix", "el" }, { "mainnet", false }, { "liquid", true }, { "development", true },
    ...
    { "electrum-mainnet",
        std::make_shared<nlohmann::json>(
            nlohmann::json({ { "name", "Electrum Mainnet" }, { "network", "electrum-mainnet" },
                { "address_explorer_url", "https://blockstream.info/address/" }, { "url", "blockstream.info:700" },
                { "tls", true }, { "tx_explorer_url", "https://blockstream.info/tx/" }, { "p2pkh_version", 0u },
                { "p2sh_version", 5u }, { "bech32_prefix", "bc" }, { "mainnet", true }, { "liquid", false },
    ...
    { "electrum-testnet",
        std::make_shared<nlohmann::json>(nlohmann::json({ { "name", "Electrum Testnet" },
            ...
            { "tls", true }, { "tx_explorer_url", "https://blockstream.info/testnet/tx/" }, { "p2pkh_version", 111u },
            { "p2sh_version", 196u }, { "bech32_prefix", "tb" }, { "mainnet", false }, { "liquid", false },
